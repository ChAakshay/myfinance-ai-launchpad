  ...
  return (
    <footer className="py-12 md:py-16 bg-slate-900 text-white">
      <div className="max-content-width">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <div className="flex items-center mb-4">
              <div className="font-bold text-xl text-white mr-2">MyFinance</div>
              <div className="bg-gradient-to-r from-financeBlue to-financeTeal-dark text-white text-xs px-2 py-1 rounded-md font-semibold">
                AI
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#demo" className="text-slate-300 hover:text-white">Demo</a></li>
              <li><a href="#waitlist" className="text-slate-300 hover:text-white">Join Waitlist</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center md:text-left text-slate-400 text-sm">
          <p>&copy; {year} MyFinance AI. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
